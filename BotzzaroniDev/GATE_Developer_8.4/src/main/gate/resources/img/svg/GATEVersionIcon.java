...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(171.1865, 254.06433);
((GeneralPath)shape).lineTo(167.88962, 258.94714);
((GeneralPath)shape).lineTo(171.1865, 258.94714);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(170.6865, 251.58777);
((GeneralPath)shape).lineTo(174.03024, 251.58777);
((GeneralPath)shape).lineTo(174.03024, 258.94714);
((GeneralPath)shape).lineTo(175.6943, 258.94714);
((GeneralPath)shape).lineTo(175.6943, 261.12683);
((GeneralPath)shape).lineTo(174.03024, 261.12683);
((GeneralPath)shape).lineTo(174.03024, 263.25183);
((GeneralPath)shape).lineTo(171.1865, 263.25183);
((GeneralPath)shape).lineTo(171.1865, 261.12683);
((GeneralPath)shape).lineTo(166.01462, 261.12683);
((GeneralPath)shape).lineTo(166.01462, 258.5487);
((GeneralPath)shape).closePath();
paint = new Color(0, 128, 0, 255);
g.setPaint(paint);
g.fill(shape);
