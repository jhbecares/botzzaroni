 ...
 *
 *  $Id: DocumentStaxUtils.java 19676 2016-10-14 05:51:04Z markagreenwood $
 */
...
public class DocumentStaxUtils {
  ...
  static Object readFeatureNameOrValue(XMLStreamReader xsr)
    ...
    // backwards compatibility only - newly serialized GATE documents will
    // use an ObjectWrapper for Collection-valued features
  ...
  public static void writeFeatures(FeatureMap features, XMLStreamWriter xsw,
    ...
    FEATURES:while(keySetIterator.hasNext()) {
      ...
      if(key != null && value != null) {
        ...
        Object item = null;
        // Test key if it is String or Number
        ...
        // Test value if it is String, Number or Boolean
