...
public class TablaEstadosAutomataEF implements Cloneable, Serializable {
	...
	public String dameEstadoSiguiente(String estadoActual, String input) {
		Hashtable transiciones = inputsDeEstados.get(estadoActual);
	...
	public boolean esEstadoFinal(String estado) {
		return (clasificacionEstados.get(estado).intValue() == TablaEstadosAutomataEF.TIPO_DE_ESTADO_FINAL);
	}
	 ...
	 */
	public void putTransicion(String estado, String input,
			String estadoSiguiente) {

		// obtenemos la tabla de inputs y operaciones
		Hashtable<String, String> inputsDeUnEstado = inputsDeEstados
				.get(estado);
