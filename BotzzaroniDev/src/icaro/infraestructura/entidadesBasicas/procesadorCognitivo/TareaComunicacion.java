...
public class TareaComunicacion extends Tarea {
	...
	public void informaraOtroAgente(Object contenido, String identAgenteReceptor) {
		...
		try {
			...
			// e.printStackTrace();
			this.trazas.aceptaNuevaTraza(new InfoTraza(identAgenteEmisor,
					"Error al enviar mensaje al agente : "
							+ identAgenteReceptor + " Contenido :  "
							+ contenido, InfoTraza.NivelTraza.error));
			this.generarInformeConCausaTerminacion(this.getIdentTarea(), null,
					identAgenteEmisor, contenido.toString(),
					CausaTerminacionTarea.ERROR);
		}

	}

	public void informaraGrupoAgentes(Object contenido,
			ArrayList<String> agentesEquipo) {
		identAgenteEmisor = this.getAgente().getIdentAgente();
		comunicacion = new ComunicacionAgentes(identAgenteEmisor);
		try {
			...
			// e.printStackTrace();
			this.trazas.aceptaNuevaTraza(new InfoTraza(identAgenteEmisor,
					"Error al enviar mensaje al grupo de agentes : "
							+ agentesEquipo + " Contenido :  " + contenido,
