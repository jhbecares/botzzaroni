...
public class ExtractedInfo {
	...
	// El contenido puede ser un objeto o una colección de entidades que se
	// obtiene a partir de mensajes o de eventos
	// Se puede crear la evidencia a partir de una collección de objetos o con
	...
	public Boolean isContentACollection() {
		...
		// if (((Object[])this.contenido).length>1)esElContenidoUnaColeccion=
		// true;
	...
	public String toString() {
		return "ExtractedInfo:" + " origen->" + this.getOrigen()
				+ " ; creador->" + this.getCreador() + " ; contenido->"
				+ this.getContenido();
	}
