...
/**
 *
 * @author Francisco J Garijo Esta clase sirve para definir la información que
 *         va en el contenido de un mensaje que se envia a un agente reactico
 *         Hay que tener en cuenta que un reactivo solo puede recibir inputs y
 *         lista de objetos con los valores para ejecutar las accioones
 *         semánticas correspondientes a la transicion
 */
public class InfoContEvtMsgAgteReactivo implements Serializable {
	...
	public InfoContEvtMsgAgteReactivo(String input,
