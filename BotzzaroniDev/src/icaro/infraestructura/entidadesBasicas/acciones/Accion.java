...
public abstract class Accion extends Thread {
	...
	public Accion(ItfUsoAutomataEFE automataItf,
			ItfGestorAcciones gestorAccionsItf) {
		super("Accion");
	...
	public void generarInputTemporizador(long milis, String idAccion,
		...
		new InformeTemporizacion(idAccion, msgTimeout);
	}
		...
		try {
			...
			if (valorTimeout <= 0) {
				trazas.trazar(
						...
						"Se ejecuta la accion "
								...
								+ NombresPredefinidos.PREFIJO_PROPIEDAD_TAREA_TIMEOUT
								+ identproperty, InfoTraza.NivelTraza.error);
				valorTimeout = this
			...
			trazas.trazar("Accion",
					"Se ejecuta la accion " + this.getIdentAccion()
							...
							+ msgTimeout, InfoTraza.NivelTraza.debug);
	...
	/*
	 * public void terminar(CausaTerminacionAccion causa) { switch (causa) {
	 * case EXITO: break; case ERROR: break; case TIMEOUT: break; case
	 * EXPECTATIVA: break; case TERMINACION_AGENTE: break; case OTRO: break; }
	 * gestorAccions.eliminarAccionActiva(this); terminada = true; }
	 */
