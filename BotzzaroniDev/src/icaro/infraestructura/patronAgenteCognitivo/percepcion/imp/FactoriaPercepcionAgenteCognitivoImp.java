 ...
 *
 */
public class FactoriaPercepcionAgenteCognitivoImp extends
		FactoriaPercepcionAgenteCognitivo {

	@Override
	// public PercepcionAgenteCognitivo crearPercepcion( AgenteCognitivo
	// cognitiveAgent) {
	public PercepcionAgenteCognitivo crearPercepcion(
			AgenteCognitivo cognitiveAgent,
			ItfProcesadorObjetivos itfProcesadorEvidencias) {
