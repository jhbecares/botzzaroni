...
public abstract class FactoriaAgenteCognitivo extends FactoriaComponenteIcaro {
	 ...
	 */
	// private static final String FACTORY_IMP_PROPERTY =
	// "icaro.infrastructure.pattern.cognitiveAgent.factory.imp";
	...
	public static FactoriaAgenteCognitivo instance() {
		if (instance == null) {
			...
			// String c =
			// System.getProperty(NombresPredefinidos.RUTA_FACTORIA_COGNITIVO,FactoriaAgenteCognitivoImp.class.getName());
			String c = System.getProperty(
					NombresPredefinidos.RUTA_FACTORIA_COGNITIVO,
					FactoriaAgenteCognitivoImp2.class.getName());
			try {
				instance = (FactoriaAgenteCognitivo) Class.forName(c)
						.newInstance();
			} catch (Exception ex) {
	...
	public abstract void createCognitiveAgent(
			DescInstanciaAgente descInstanciaAgente) throws Exception;

	public abstract void crearAgenteCognitivo(
			DescInstanciaAgente descInstanciaAgente) throws Exception;
}
