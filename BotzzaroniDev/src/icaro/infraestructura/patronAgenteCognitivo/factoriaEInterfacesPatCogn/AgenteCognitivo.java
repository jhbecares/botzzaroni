 ...
 */
public abstract class AgenteCognitivo extends UnicastRemoteObject implements
		ItfUsoAgenteCognitivo, InterfazGestion {

	public AgenteCognitivo() throws java.rmi.RemoteException {
	}

	public abstract void setComponentesInternos(
