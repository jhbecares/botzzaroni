...
public interface ItfConsumidorPercepcion {
	 ...
	 *            Tiempo que se esperar como mximo
	 * @return Objeto que se ha consumido
	 * @exception ExcepcionSuperadoTiempoLimite
	 *                No se consiguio consumir en el tiempo especificado
	 * @todo producen
	 */
	...
	/**
	 * Consume un objeto, se queda esperando hasta que haya un objeto que
	 * consumir
	 *
	 * @return Objeto que se ha consumido
	 */
