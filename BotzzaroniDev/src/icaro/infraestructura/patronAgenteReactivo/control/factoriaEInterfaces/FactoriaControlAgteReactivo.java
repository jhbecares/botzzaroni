...
public abstract class FactoriaControlAgteReactivo {
	...
	public static FactoriaControlAgteReactivo instancia() {
		...
		if (instancia == null) {
			String clase = System
					.getProperty(
							"icaro.infraestructura.patronAgenteReactivo.control.factoriaEInterfaces.imp",
							"icaro.infraestructura.patronAgenteReactivo.control.factoriaEInterfaces.imp.FactoriaControlAgteReactivoImp2");
			try {
				instancia = (FactoriaControlAgteReactivo) Class.forName(clase)
						.newInstance();
			} catch (Exception ex) {
	...
	// public abstract ProcesadorEventosAbstracto
	// crearControl(ItfConsumidorPercepcion percConsumidor, AutomataEFEAbstracto
	// automata,
	// ItfProductorPercepcion percProductor, String nombreDelControl);
	public abstract ProcesadorInfoReactivoAbstracto crearControlAgteReactivo(
