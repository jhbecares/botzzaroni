...
public abstract class ProcesadorInfoReactivoAbstracto extends Thread implements
		ItfControlAgteReactivo {
	...
	public abstract void inicializarInfoGestorAcciones(String identAgte,
			ItfProductorPercepcion itfEvtosInternos);
	// public synchronized void procesarInfoControlAgteReactivo (Object
	// infoParaProcesar ) {
	// if(this.estado == InterfazGestion.ESTADO_ACTIVO)
	// if( infoParaProcesar instanceof InfoContEvtMsgAgteReactivo){
	// InfoContEvtMsgAgteReactivo infoParaAutomata =
	// (InfoContEvtMsgAgteReactivo) infoParaProcesar;
