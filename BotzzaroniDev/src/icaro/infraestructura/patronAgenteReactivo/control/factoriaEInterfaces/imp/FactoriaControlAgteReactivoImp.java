...
public class FactoriaControlAgteReactivoImp extends FactoriaControlAgteReactivo {
	...
	@Override
	public ProcesadorEventosImp crearControlAgteReactivo(
		...
		try {
			this.accionesSemanticas = new EjecutorDeAccionesImp(
			...
			automataControl = new AutomataEFEImp(nombreFicheroTablaEstados,
					...
					nombreDelAgente);
			return new ProcesadorEventosImp(automataControl,
					accionesSemanticasEspecificas, percProductor,
					percConsumidor, nombre);
		} catch (Exception ExcepcionNoSePudoCrearAutomataEFE) {
			logger.error("Error al crear el automata del agente "
					+ nombreDelAgente + " utilizando el fichero "
					+ nombreFicheroTablaEstados);
			trazas.aceptaNuevaTraza(new InfoTraza(nombreDelAgente,
					"Error al crear el automata del agente " + nombreDelAgente
	...
	@Override
	public ProcesadorInfoReactivoImp crearControlAgteReactivo(
			AccionesSemanticasAgenteReactivo accionesSemanticasEspecificas,
