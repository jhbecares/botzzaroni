...
public abstract class AgenteReactivoAbstracto extends UnicastRemoteObject
		implements ItfGestionAgenteReactivo, ItfUsoAgenteReactivo {

	public AgenteReactivoAbstracto() throws java.rmi.RemoteException {
	}

	public abstract void setParametrosLoggerAgReactivo(String archivoLog,
			String nivelLog);
	...
	public abstract void setComponentesInternos(String nombreAgente,
	...
	public abstract AgenteReactivoAbstracto AgenteReactivoImplementacion(
