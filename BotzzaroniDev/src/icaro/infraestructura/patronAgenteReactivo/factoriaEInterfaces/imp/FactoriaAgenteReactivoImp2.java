...
public class FactoriaAgenteReactivoImp2 extends FactoriaAgenteReactivo {
	 ...
	 * acciones sem�nticas, el aut�mata que define el comportamiento y el
	 * nombre del agente.
	 */
	...
	public void crearAgenteReactivo(DescInstanciaAgente descInstanciaAgente)
		...
		if ((accionesSemanticasEspecificas != null) & (rutaTabla != null)) {
			...
			try {
				...
				accionesSemanticasEspecificas
						.setCtrlGlobalAgenteReactivo(agente);
	...
	public void crearAgenteReactivo(String nombreInstanciaAgente,
		...
		try {
			...
			trazas.aceptaNuevaTraza(new InfoTraza(nombreInstanciaAgente,
					tipoEntidad, nombreInstanciaAgente
							+ ":Creacion del Agente ...ok", NivelTraza.debug));
			...
			if (rutaAutomata != null) {
				...
				trazas.trazar(this.getClass().getName(), msgInfoUsuario,
						NivelTraza.error);
				new InfoTraza(NombresPredefinidos.CONFIGURACION, tipoEntidad,
	...
	private Class obtenerClaseAccionesSemanticas(String rutaComportamiento)
			throws ExcepcionEnComponente {
		// rutaComportamiento = "/" +rutaComportamiento.replace(".", "/");
		String nombreEntidad = rutaComportamiento.substring(rutaComportamiento
				.lastIndexOf(".") + 1);
		String primerCaracter = nombreEntidad.substring(0, 1);
		nombreEntidad = nombreEntidad.replaceFirst(primerCaracter,
				primerCaracter.toUpperCase());
