...
public class ControlRMI {
	...
	public static boolean fireAll() {
		...
		try {
			if (trazas != null) {
				trazas.aceptaNuevaTraza(new InfoTraza("ControlRMI",
	...
	/* ********************************************************************** */
	/* ********************************************************************** */
	public static ItfUsoAgenteReactivo buscarAgenteRemoto(String ip,
		...
		try {
			if (regCliente == null) {
				...
				if (trazas != null) {
					trazas.aceptaNuevaTraza(new InfoTraza("ControlRMI (null)",
							"No consigo encontrar al agente: " + nombreAgente
									+ " en ip:" + ip + " puerto:" + puerto,
							NivelTraza.error));
				}
			}
			...
			if (trazas != null) {
				trazas.aceptaNuevaTraza(new InfoTraza("ControlRMI (Excepcion)",
						"No consigo encontrar al agente: " + nombreAgente
								+ " en ip:" + ip + " puerto:" + puerto,
						NivelTraza.error));
			}
