 ...
 */
public abstract class ClaseGeneradoraConfiguracion extends ImplRecursoSimple
		implements ItfUsoConfiguracion {
	...
	public static ClaseGeneradoraConfiguracion instance(
			String descripcionXMLAlternativo) throws ExcepcionEnComponente,
			RemoteException {
		if (instance == null) {
