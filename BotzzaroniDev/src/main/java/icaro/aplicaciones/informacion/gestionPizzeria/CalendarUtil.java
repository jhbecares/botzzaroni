...
public final class CalendarUtil {
	 ...
	 * @return True if the given day, month and year combination is a valid
	 *         date.
	 */
	 ...
	 * @return True if the given hour, minute and second combination is a valid
	 *         time.
	 */
	 ...
	 * @param minute
	 *            The minute part of the date.
	 * @param second
	 *            The second part of the date.
	 * @return True if the given day, month, year, hour, minute and second
	 *         combination is a valid date.
	 */
	public static boolean isValidDate(int year, int month, int day, int hour,
	 ...
	 *             If the given date elements does not represent a valid date.
	 */
	...
	/**
	 * Add the given amount of years to the given calendar. The changes are
	 * reflected in the given calendar.
	 * 
	 * @param calendar
	 *            The calendar to add the given amount of years to.
	 * @param years
	 *            The amount of years to be added to the given calendar.
	...
	/**
	 * Add the given amount of hours to the given calendar. The changes are
	 * reflected in the given calendar.
	 * 
	 * @param calendar
	 *            The calendar to add the given amount of hours to.
	 * @param hours
	 *            The amount of hours to be added to the given calendar.
	 *            Negative values are also allowed, it will just go back in
	 *            time.
	 */
	...
	/**
	 * Add the given amount of minutes to the given calendar. The changes are
	 * reflected in the given calendar.
	 * 
	 * @param calendar
	 *            The calendar to add the given amount of minutes to.
	 * @param minutes
	 *            The amount of minutes to be added to the given calendar.
	 *            Negative values are also allowed, it will just go back in
	 *            time.
	 */
	...
	/**
	 * Add the given amount of seconds to the given calendar. The changes are
	 * reflected in the given calendar.
	 * 
	 * @param calendar
	 *            The calendar to add the given amount of seconds to.
	 * @param seconds
	 *            The amount of seconds to be added to the given calendar.
	 *            Negative values are also allowed, it will just go back in
	 *            time.
	 */
	...
	/**
	 * Add the given amount of millis to the given calendar. The changes are
	 * reflected in the given calendar.
	 * 
	 * @param calendar
	 *            The calendar to add the given amount of millis to.
	 * @param millis
	 *            The amount of millis to be added to the given calendar.
	 *            Negative values are also allowed, it will just go back in
	 *            time.
	 */
	...
	public static boolean sameHour(Calendar one, Calendar two) {
		return one.get(Calendar.HOUR_OF_DAY) == two.get(Calendar.HOUR_OF_DAY)
				&& sameDay(one, two);
	}
	...
	public static boolean sameMinute(Calendar one, Calendar two) {
		return one.get(Calendar.MINUTE) == two.get(Calendar.MINUTE)
				&& sameHour(one, two);
	}
	...
	public static boolean sameSecond(Calendar one, Calendar two) {
		return one.get(Calendar.SECOND) == two.get(Calendar.SECOND)
				&& sameMinute(one, two);
	}

	/**
	 * Returns <tt>true</tt> if the two given calendars are dated on the same
	 * time. The difference from <tt>one.equals(two)</tt> is that this method
	 * does not respect the time zone.
	 * 
	 * @param one
	 *            The one calendar.
	 * @param two
	 ...
	 * 
	 * @param before
	 *            The first calendar with expected date before the second
	 *            calendar.
	 * @param after
	 *            The second calendar with expected date after the first
	 *            calendar.
	...
	public static int elapsedHours(Calendar before, Calendar after) {
		return (int) elapsedMillis(before, after, 3600000); // 1h = 60m = 3600s
															// = 3600000ms
	}
	...
	/**
	 * Retrieve the amount of elapsed milliseconds between the two given
	 * calendars.
	 * 
	 * @param before
	 *            The first calendar with expected date before the second
	 ...
	 *            The second calendar with expected date after the first
	 *            calendar.
	 * @return The amount of elapsed milliseconds between the two given
	 *         calendars.
	 * @throws IllegalArgumentException
	 *             If the first calendar is dated after the second calendar.
	 */
	 ...
	 * two given calendars. It returns an int array with the elapsed years,
	 ...
	 *            The second calendar with expected date after the first
	 *            calendar.
	 * @return The elapsed time between the two given calendars in years,
	 ...
	 * on the given calendar field as definied in the Calendar constants, e.g.
	 ...
	 *            calendar.
	 * @param field
	 *            The calendar field as definied in the Calendar constants.
	...
	/**
	 * Retrieve the amount of elapsed milliseconds between the two given
	 * calendars and directly divide the outcome by the given factor. E.g.: if
	 * the division factor is 1, then you will get the elapsed milliseconds
	 * unchanged; if the division factor is 1000, then the elapsed milliseconds
	 * will be divided by 1000, resulting in the amount of elapsed seconds.
	 * 
	 * @param before
	 *            The first calendar with expected date before the second
	 *            calendar.
	 ...
	 *            calendar.
	 * @param factor
	 *            The division factor which to divide the milliseconds with,
	 *            expected to be at least 1.
	 * @return The amount of elapsed milliseconds between the two given
	 *         calendars, divided by the given factor.
	 * @throws IllegalArgumentException
	 *             If the first calendar is dated after the second calendar or
	 *             if the division factor is less than 1.
	 */
	private static long elapsedMillis(Calendar before, Calendar after,
			int factor) {
		checkBeforeAfter(before, after);
		if (factor < 1) {
			throw new IllegalArgumentException("Division factor '" + factor
