...
public class ClaseGeneradoraVisualizacionAcceso extends ImplRecursoSimple
		implements ItfUsoVisualizadorAcceso {
	...
	public void mostrarVisualizadorAcceso(String nombreAgente, String tipo) {
		this.identAgenteAReportar = nombreAgente;
		this.notifAgente.setIdentificadorAgenteAReportar(identAgenteAReportar);
		System.out.println("El agente al que se deben enviar los eventos es :"
				+ nombreAgente);
	...
	public void mostrarMensajeInformacion(String titulo, String mensaje) {
		...
		trazas.aceptaNuevaTraza(new InfoTraza(nombredeEsteRecurso,
				"Mostrando mensaje de informacion", InfoTraza.NivelTraza.debug));
		 ...
		 * +NombresPredefinidos.NOMBRE_AGENTE_APLICACION+"Acceso");
		 * itfUsoAgente.aceptaEvento(new
		 * EventoInput("termina","VisualizadorAcceso"
		 * ,NombresPredefinidos.NOMBRE_AGENTE_APLICACION+"Acceso"));
		 * 
