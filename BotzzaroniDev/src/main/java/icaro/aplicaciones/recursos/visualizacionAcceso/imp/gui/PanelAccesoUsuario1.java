...
public class PanelAccesoUsuario1 extends VentanaEstandar {
	...
	public PanelAccesoUsuario1(ClaseGeneradoraVisualizacionAcceso visualizador) {
		...
		this.addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent e) {
				...
				JOptionPane
						.showMessageDialog(
								null,
								"Como el control est� en el agente, la ventana no podr� cerrar el sistema directamente.\n Si "
		...
		layout.setVerticalGroup(layout
				...
				.add(layout
						...
						.add(layout
								...
								.add(labelPwd))
						.addPreferredGap(
								org.jdesktop.layout.LayoutStyle.RELATED, 61,
								Short.MAX_VALUE)
						.add(layout
								.createParallelGroup(
										org.jdesktop.layout.GroupLayout.BASELINE)
	...
	private void botonAccessActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if ((usr.equals("")) || (pwd.equals(""))) {
			usoAgente
					.getVisualizador()
					.mostrarMensajeError("Acceso no Valido",
							"Verifique que ha introducido un nombre de usuario y una clave correcta");
		} else {
			usoAgente.peticionAutentificacion(textoUsr.getText(),
					textoPwd.getText());
		}
