...
public abstract class ClaseGeneradoraRepositorioInterfaces extends
		ImplRecursoSimple implements ItfUsoRepositorioInterfaces {
	...
	// public static final String IMP_LOCAL =
	// "icaro.infraestructura.recursosOrganizacion.repositorioInterfaces.imp.RepositorioInterfacesImpLocal";
	// public static final String IMP_CORBA =
	// "icaro.infraestructura.recursosOrganizacion.repositorioInterfaces.impCORBA.RepositorioInterfacesCORBA";
	...
	public static ClaseGeneradoraRepositorioInterfaces instance(
		...
		if (instance == null) {
			try {
				...
				instance = (ClaseGeneradoraRepositorioInterfaces) imp
						.newInstance();
			} catch (Exception e) {
				e.printStackTrace();
			}
	...
	@Override
	public abstract Object obtenerInterfazGestion(String nombre)
			throws Exception;
	...
	@Override
	public abstract Boolean estaRegistradoEsteNombre(String nombreEntidad)
			throws Exception;

	@Override
	public abstract Boolean estaRegistradoEsteRecurso(String nombreRecurso)
			throws Exception;

	@Override
	public abstract ArrayList nombresAgentesAplicacionRegistrados()
			throws Exception;
