...
public class PanelTrazasAgteCognitivo extends PanelTrazasAbstracto {
	...
	public synchronized void muestraMensajeEnviado(MensajeSimple m) {
		...
		areaTrazaMensajes
				.append("Mensaje Enviado--> Emisor : " + m.getEmisor()
						+ "  envia   mensaje al agente : " + m.getReceptor()
						+ " Clase del Contenido: "
	...
	public synchronized void muestraMensajeRecibido(MensajeSimple m) {
		...
		areaTrazaMensajes.append("Mensaje Recibido --> Emisor : "
				+ m.getEmisor() + ". Clase del Contenido: "
				+ m.getContenido().getClass().getSimpleName() + "\n"
				+ "Valores Contenido : " + "\n" + m.getContenido() + "\n");
		// si escribo null,borra lo anterior
	}
	...
	public synchronized void muestraEventoRecibido(EventoSimple evto) {
		...
		if (contenido != null) {
			...
			areaTrazaEventos.append("Evento Recibido Emisor : "
					+ evto.getOrigen() + ". Tipo Contenido: "
					+ evto.getContenido().getClass().getSimpleName() + ""
	...
	private void initComponents() {
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(
				...
				areaTrazas, javax.swing.GroupLayout.DEFAULT_SIZE, 492,
				Short.MAX_VALUE));
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				areaTrazas, javax.swing.GroupLayout.DEFAULT_SIZE, 336,
				Short.MAX_VALUE));
		...
		jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				areaTrazaMensajes, javax.swing.GroupLayout.DEFAULT_SIZE, 492,
				Short.MAX_VALUE));
		jPanel2Layout.setVerticalGroup(jPanel2Layout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				areaTrazaMensajes, javax.swing.GroupLayout.DEFAULT_SIZE, 336,
				Short.MAX_VALUE));
		...
		jPanel3Layout.setHorizontalGroup(jPanel3Layout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				areaTrazaEventos, javax.swing.GroupLayout.DEFAULT_SIZE, 492,
				Short.MAX_VALUE));
		jPanel3Layout.setVerticalGroup(jPanel3Layout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				areaTrazaEventos, javax.swing.GroupLayout.Alignment.TRAILING,
		...
		jPanel5Layout.setHorizontalGroup(jPanel5Layout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				areaEjecReglas, javax.swing.GroupLayout.DEFAULT_SIZE, 492,
				Short.MAX_VALUE));
		jPanel5Layout.setVerticalGroup(jPanel5Layout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				areaEjecReglas, javax.swing.GroupLayout.DEFAULT_SIZE, 336,
				Short.MAX_VALUE));
		...
		jPanel6Layout.setHorizontalGroup(jPanel6Layout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				areaActivReglas, javax.swing.GroupLayout.DEFAULT_SIZE, 492,
				Short.MAX_VALUE));
		jPanel6Layout.setVerticalGroup(jPanel6Layout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				areaActivReglas, javax.swing.GroupLayout.DEFAULT_SIZE, 336,
				Short.MAX_VALUE));
		...
		layout.setHorizontalGroup(layout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				panelCognitivo, javax.swing.GroupLayout.Alignment.TRAILING));
