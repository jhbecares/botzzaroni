...
public class InfoPanelesEspecificos {
	...
	public PanelTrazasAbstracto getPanelEspecifico(String entityId) {
		...
		// infoPanelEspecifico =(InfoPanelEspecifico)
		// tablaPanelesEspecificos.get(entityId);
		// if (infoPanelEspecifico != null) return
		// infoPanelEspecifico.getPanelEspecifico();
		// else return null;
	...
	public synchronized PanelTrazasAbstracto crearPanelparaEntidad(
			String entityId, NombresPredefinidos.TipoEntidad entityType) {
		PanelTrazasAbstracto panel = (PanelTrazasAbstracto) tablaPanelesEspecificos
				.get(entityId);
		if (panel == null) {
			if (entityType.equals(NombresPredefinidos.TipoEntidad.noDefinido)) {
				panel = new PanelTrazasGenerico(entityId, "");
			} else if (entityType
					.equals(NombresPredefinidos.TipoEntidad.Reactivo)) {
				panel = new PanelTrazasAgteReactivo(entityId, "");
			} else if (entityType
					.equals(NombresPredefinidos.TipoEntidad.Recurso)) {
