...
public class PanelTrazasAgteReactivo extends PanelTrazasAbstracto {
	...
	public synchronized void muestraMensajeRecibido(MensajeSimple m) {
		...
		areaTrazaMensajes
				.append("Mensaje Recibido --> Emisor : " + m.getEmisor()
						+ ". Clase del Contenido: "
	...
	public synchronized void muestraEventoEnviado(EventoSimple m) {
		...
		if (contenido != null) {
			// if contenido.getClass().getSimpleName().equalsIgnoreCase(nivel)
			areaTrazaEventos.append("Evento enviado.  Emisor : "
					+ m.getOrigen() + ". Tipo Contenido: "
					+ m.getContenido().getClass().getSimpleName() + ""
					+ ". Contenido : " + contenido.toString() + "\n");// +". Entidad emisora: "+traza.getEntidadEmisora()+"\n");
		}
	...
	private void initComponents() {
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(
				...
				areaTrazaGeneral, javax.swing.GroupLayout.DEFAULT_SIZE, 475,
				Short.MAX_VALUE));
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				areaTrazaGeneral, javax.swing.GroupLayout.DEFAULT_SIZE, 347,
				Short.MAX_VALUE));
		...
		jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				areaTrazaMensajes, javax.swing.GroupLayout.DEFAULT_SIZE, 475,
				Short.MAX_VALUE));
		jPanel2Layout.setVerticalGroup(jPanel2Layout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				areaTrazaMensajes, javax.swing.GroupLayout.DEFAULT_SIZE, 347,
				Short.MAX_VALUE));
