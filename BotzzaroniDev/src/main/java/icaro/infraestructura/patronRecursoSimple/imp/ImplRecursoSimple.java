...
public class ImplRecursoSimple extends UnicastRemoteObject implements
		ItfUsoRecursoSimple, ItfGestionRecursoSimple, Serializable {

	private static final long serialVersionUID = 1L;
	// public final static String ficheroAutomataCicloVida =
	// "/icaro/infraestructura/patronRecursoSimple/TablaEstadosCicloVidaRecursos.xml";
	...
	public ImplRecursoSimple(String idRecurso) throws RemoteException {
		// this.estadoAutomata = new
		// AutomataCicloVidaRecurso(fichero_automata_ciclo_vida, 2);

		// ItfUsoAutomataCicloVidaRecurso AutomataItf =
		// (ItfUsoAutomataCicloVidaRecurso)
	...
	/*
	 * public void arrancaConEvento() { //this.estado =
	 * InterfazGestion.ESTADO_ACTIVO; this.estadoAutomata.transita("arrancar");
	 * this.estadoAutomata.transita("ok"); }
	 * 
	 * public void arrancaConInput(String nombreInput) { //this.estado =
	 * InterfazGestion.ESTADO_ACTIVO; this.estadoAutomata.transita(nombreInput);
	 * this.estadoAutomata.transita("ok"); }
	 */
	@Override
	public void para() {
	...
	/*
	 * public int monitorizacion() throws RemoteException { return this.estado;
	 * }
	 */
	...
	/*
	 * public String obtenerEstado() { return this.estadoAutomata.monitorizar();
	 * }
	 */
	 ...
	 * @uml.property name="itfUsoRepositorioInterfaces"
	 */
	public void setItfUsoRepositorioInterfaces(
	...
	public void setItfAutomataCicloDeVida(
			ItfUsoAutomataEFsinAcciones AutomataItf) {
		this.itfAutomata = AutomataItf;
	}
