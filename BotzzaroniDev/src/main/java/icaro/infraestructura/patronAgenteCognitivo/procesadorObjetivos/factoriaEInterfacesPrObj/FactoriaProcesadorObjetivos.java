...
public abstract class FactoriaProcesadorObjetivos {
	...
	public static FactoriaProcesadorObjetivos instance() {
		if (instance == null) {
			...
			String c = System.getProperty(FACTORY_IMP_PROPERTY,
					FactoriaProcesadorObjetivosImp1.class.getName());

			try {
				instance = (FactoriaProcesadorObjetivos) Class.forName(c)
						.newInstance();
	...
	public abstract ProcesadorObjetivos crearProcesadorObjetivos(
			AgenteCognitivo cognitiveAgent, String goalResolutionFile)
			throws Exception;
