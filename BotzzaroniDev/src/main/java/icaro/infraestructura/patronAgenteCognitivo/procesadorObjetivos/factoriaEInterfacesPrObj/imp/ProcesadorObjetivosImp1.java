...
public class ProcesadorObjetivosImp1 extends ProcesadorObjetivos {
	...
	public ProcesadorObjetivosImp1(ItfMotorDeReglas ruleEngine,
	...
	public boolean cambiarComportamiento(String identFicheroReglasComportamiento) {
		InputStream reglas = this.getClass().getResourceAsStream(
	...
	public void inicializaVariablesGlobales() {
		ruleEngine.addGlobalVariable(NombresPredefinidos.TASK_MANAGER_GLOBAL,
				taskManager);
		ruleEngine.addGlobalVariable(
				NombresPredefinidos.ITFUSO_RECURSOTRAZAS_GLOBAL,
				NombresPredefinidos.RECURSO_TRAZAS_OBJ);
		ruleEngine.addGlobalVariable(NombresPredefinidos.AGENT_ID_GLOBAL,
				idAgente);
	}
}
