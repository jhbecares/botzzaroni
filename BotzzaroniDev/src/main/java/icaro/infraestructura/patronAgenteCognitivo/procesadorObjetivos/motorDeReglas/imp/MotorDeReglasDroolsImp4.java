 ...
 * Modificado 5 de noviembre de 2013
 *
...
public class MotorDeReglasDroolsImp4 implements ItfMotorDeReglas,
		ItfConfigMotorDeReglas {

	private AgenteCognitivo agent; // inicializada en el constructor
	private StatefulKnowledgeSession kSesion; // inicializada en el metodo
	// compileRules
	...
	public MotorDeReglasDroolsImp4(AgenteCognitivo agent) {
	...
	//
	// InputStream file =
	// MotorDeReglasDroolsImp4.class.getResourceAsStream(rules);
	//
