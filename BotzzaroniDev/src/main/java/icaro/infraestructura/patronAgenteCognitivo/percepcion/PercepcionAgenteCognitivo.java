 ...
 *
 */
public abstract class PercepcionAgenteCognitivo implements ItfEventoSimpe,
		ItfMensajeSimple, ItfGestPercepcionAgenteCognitivo {
	public abstract void SetParametrosPercepcionAgenteCognitivoImp(
