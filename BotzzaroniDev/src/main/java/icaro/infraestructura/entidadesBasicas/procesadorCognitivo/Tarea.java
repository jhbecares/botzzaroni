...
public abstract class Tarea extends Thread {
	...
	public Tarea(ItfProcesadorObjetivos envioHechos, AgenteCognitivo agente,
	...
	/*
	 * public void terminar(CausaTerminacionTarea causa) { switch (causa) { case
	 * EXITO: break; case ERROR: break; case TIMEOUT: break; case EXPECTATIVA:
	 * break; case TERMINACION_AGENTE: break; case OTRO: break; }
	 * gestorTareas.eliminarTareaActiva(this); terminada = true; }
	 */
