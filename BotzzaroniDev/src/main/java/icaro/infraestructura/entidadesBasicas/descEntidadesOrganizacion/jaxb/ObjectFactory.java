...
public class ObjectFactory {
	...
	private final static QName _DescOrganizacion_QNAME = new QName(
			"urn:icaro:aplicaciones:descripcionOrganizaciones",
			"DescOrganizacion");
	...
	public JAXBElement<DescOrganizacion> createDescOrganizacion(
			DescOrganizacion value) {
		return new JAXBElement<DescOrganizacion>(_DescOrganizacion_QNAME,
				DescOrganizacion.class, null, value);
	}
