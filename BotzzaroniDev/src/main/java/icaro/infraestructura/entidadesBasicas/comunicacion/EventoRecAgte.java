...
public class EventoRecAgte extends EventoSimple {
	...
	public EventoRecAgte(String input, Object msgParametro, String origen,
			String destino) {
	...
	public EventoRecAgte(String input, Object[] msgParametros, String origen,
			String destino) {
	...
	/*
	 * public String getOrigen(){ // if (origen!=null)
	 * 
	 * return origen; else return "origen no especificado"; } /**
	 * 
	 * @param origen
	 * 
