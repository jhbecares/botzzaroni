...
public class InformeDeTarea extends Informe {
	...
	public InformeDeTarea(String idTarea, String idAgenteEmisor,
			Object contenido) {
	...
	public InformeDeTarea(String idTarea, String contxtGoal,
			String idAgenteEmisor, Object contenido) {
	...
	public String toString() {
		return "InformeDeTarea: " + "Tarea->" + this.getIdentTarea()
				+ " ; AgenteEmisor->" + this.getidentAgenteEmisor()
				+ " ; Contenido->" + this.getContenidoInforme()
				+ " ; contextGoal->" + this.getReferenciaContexto();
	}
