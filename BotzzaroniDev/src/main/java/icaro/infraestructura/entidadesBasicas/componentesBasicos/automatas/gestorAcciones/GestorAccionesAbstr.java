...
public abstract class GestorAccionesAbstr implements ItfGestorAcciones {
	...
	private Logger log = Logger
			.getLogger(icaro.infraestructura.patronAgenteReactivo.control.GestorAccionesAgteReactivoImp.class);
	...
	public void GestorAcciones(String propietarioId) {
		...
		// accionesSemAgteReactivoSimpleName =
		// AccionesSemanticasAgenteReactivo.class.getSimpleName();
	...
	public abstract void inicializarInfoAcciones(Class claseAccionAinicializar,
			Object... paramsInicializacion) throws Exception;

	@Override
	public abstract void ejecutar(Object... paramsEjecucion) throws Exception;

	@Override
	public abstract void ejecutarAccion(Class claseAccionEjecutar,
			Object... paramsEjecucion) throws Exception;

	@Override
	public abstract void ejecutarMetodo(Class claseAccionEjecutar,
