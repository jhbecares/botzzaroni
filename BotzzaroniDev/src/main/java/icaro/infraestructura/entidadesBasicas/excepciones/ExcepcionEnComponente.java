...
public class ExcepcionEnComponente extends java.lang.Exception {
	...
	public ExcepcionEnComponente(String causa, String identParteAfectada,
	...
	public ExcepcionEnComponente(String identComponente, String causa,
	...
	public void putParteAfectada(String identParteAfectada) {
		this.identParteAfectada = this.identParteAfectada + "Parte Afectada:"
				+ identParteAfectada;
	}
	...
	public void putCompDondeEstaContenido(String identSuperComponente) {
		this.identSuperComponente = this.identSuperComponente + "contenido en:"
				+ identSuperComponente;
	}
