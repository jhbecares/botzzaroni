...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateDateRangeInput(oTable) {
            ...
            //th.html(_fnRangeLabelPart(0));
            var sFromId = oTable.attr("id") + '_range_from_' + i;
            var from = $('<input type="text" placeholder="dd/mm/yyyy" class="date_range_filter form-control" id="' + sFromId + '" rel="' + i + '"/>');
            from.datepicker();
            //th.append(from);
            //th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
            var to = $('<input type="text" placeholder="dd/mm/yyyy" class="date_range_filter form-control" id="' + sToId + '" rel="' + i + '"/>');
            //th.append(to);
            //th.append(_fnRangeLabelPart(2));
            
            var dateRange1 = '<div class="col-xs-6"><div class="form-group form-group-sm"><label class="col-sm-3 control-label">'+aoFragments[0]+'</label><div class="date_from col-sm-9"></div></div></div>';
            var dateRange2 = '<div class="col-xs-6"><div class="form-group form-group-sm"><label class="col-sm-3 control-label">'+aoFragments[2]+'</label><div class="date_to col-sm-9"></div></div></div>';
            th.append(dateRange1+""+dateRange2);
            th.find('.date_from').append(from);
            th.find('.date_to').append(to);
