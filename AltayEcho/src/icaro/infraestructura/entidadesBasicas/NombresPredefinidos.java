...
public class NombresPredefinidos {
	...
	// public static final String EXPR_REG_NOMBRE_FICHERO_AS =
	// "AccionesSemanticas([0-9a-zA-Z])*.class";
	...
	// public static final String EXPR_REG_NOMBRE_FICHERO_AUTOMATA =
	// "automata*.xml";
	// public static final String EXPR_REG_NOMBRE_FICHERO_REGLAS =
	// "reglas([0-9a-zA-Z])*.drl";
	...
	// public static final String FACTORIA_AGENTE_COGNITIVO =
	// "FactoriaAgenteCognitivo";
	...
	// public static final String RUTA_DESCRIPCIONES =
	...
	// public final static String FICHERO_AUTOMATA_CICLO_VIDA_COMPONENTE =
	// "/icaro/infraestructura/patronRecursoSimple/TablaEstadosCicloVidaRecursos.xml";
	// public final static String FICHERO_AUTOMATA_CICLO_VIDA_COMPONENTE =
	// "./schemas/TablaEstadosCicloVidaRecursos.xml";
