...
public class GestorAccionesGenImp implements ItfGestorAcciones {
	...
	// public AccionesSemanticasAgenteReactivo getInstanceASagteReactivo(Class
	// accionClass){
	//
	...
	// (AccionesSemanticasAgenteReactivo)accionClass.newInstance();
	...
	// java.util.logging.Logger.getLogger(GestorAccionesAgteReactivoImp.class.getName()).log(Level.SEVERE,
	// null, ex);
	...
	public synchronized void ejecutarMetodo(Class claseAccionEjecutar,
		...
		claseAccionEjecutar.getSuperclass().getSimpleName();
		// String accionId = accionesSemAgteReactivo.getClass().getName();
		// if (superclase.equals(accionesSemAgteReactivoSimpleName) ){
		// if(accionesSemAgteReactivo==null) accionesSemAgteReactivo =
		// getInstanceASagteReactivo(claseAccionEjecutar);
		//
		...
		try {
			...
			System.out
					.println("ERROR en los privilegios de acceso (no es publico) para en metodo: "
							+ identMetodo
							+ " de la clase: "
							+ claseAccionEjecutar.getClass().getName());
			iae.printStackTrace();
