...
public abstract class ClaseGeneradoraAutomataEFsinAcciones implements
		ItfUsoAutomataEFsinAcciones {
	...
	// private static InterpreteTablaEstadosAutomataSinAcciones
	// interpreteTablaEstados;
	...
	public static ClaseGeneradoraAutomataEFsinAcciones instance(
			String rutaFicheroTablaEstados) {
		if (instance == null) {
			// Creo el interprete de la tabla y luego el automata
			// interpreteTablaEstados = new
			// InterpreteTablaEstadosAutomataSinAcciones();
			interpreteTablaEstados = new XMLParserTablaEstadosAutomataEF();
			tablaEstadosAutomata = interpreteTablaEstados
					.extraeTablaEstadosDesdeFicheroXML(rutaFicheroTablaEstados);
			// instance = new AutomataSinAccionesControlImp(
			// tablaEstadosAutomata,traza);

		}
		// Hacemos una copia de la Tabla de estados
		{
			tablaEstadosAutomata = (TablaEstadosAutomataEF) tablaEstadosAutomata
					.clone();
			instance = new AutomataSinAccionesControlImp(tablaEstadosAutomata,
					traza);
		}
		return instance;
	}
