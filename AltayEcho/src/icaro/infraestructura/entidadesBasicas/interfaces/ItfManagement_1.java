 ...
 */
public interface ItfManagement_1 {
	...
	/**
	 * Detiene el servicio del elemento momentneamente Esta operacion es
	 * OPCIONAL
	 *
	 * @exception Exception
	 */
	...
	/**
	 * Reanuda la disponibilidad del elemento si estaba parado, si no lo estaba
	 * no hace nada. Esta operacion es OPCIONAL
	 *
	 * @exception Exception
	 */
