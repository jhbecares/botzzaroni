...
public class DescInstancia implements Serializable {
	...
	public boolean esDirigidoPorObjetivos() {
		return (tipoComponente.equals(TipoAgente.ADO.value()) || tipoComponente
				.equals(TipoAgente.COGNITIVO.value()))
				|| tipoComponente.equals(TipoAgente.DIRIGIDO_POR_OBJETIVOS
						.value());
