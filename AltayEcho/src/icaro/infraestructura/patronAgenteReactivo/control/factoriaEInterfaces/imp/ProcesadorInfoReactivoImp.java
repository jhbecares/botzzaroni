 ...
 */
public class ProcesadorInfoReactivoImp extends ProcesadorInfoReactivoAbstracto
	 ...
	 */
	public ProcesadorInfoReactivoImp(AutomataEFEImp automata,
	...
	// {
	// throw new
	// java.lang.UnsupportedOperationException("El metodo continua() an no est implementado.");
	// }
	...
	// {
	// throw new
	// java.lang.UnsupportedOperationException("El metodo para() an no est implementado.");
	// }
	 ...
	 *            transite y ejecute las acciones correspondientes // El control
	 *            vuelve si la ejecucion de las acciones termina. Si la accion
	 *            es no bloqueante siempre vuelve ArrayList contenidoMsg =
	 *            (ArrayList) msg.getContenido(); String inputExtraido =
	 *            contenidoMsg.get(0).toString().trim(); // Los parametros deben
	 *            ir en el resto de los elementos del array if
	 ...
	 */
	@Override
	public synchronized void setGestorAReportar(
