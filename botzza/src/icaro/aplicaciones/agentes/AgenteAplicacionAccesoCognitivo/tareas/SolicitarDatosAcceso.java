...
public class SolicitarDatosAcceso extends Tarea {
	...
	public void ejecutar(Object... params) {
		...
		try {
			// Se busca la interfaz del visualizador en el repositorio de
			// interfaces
			...
			if (visualizadorAcceso != null) {
				visualizadorAcceso.mostrarVisualizadorAcceso(this.getAgente()
						.getIdentAgente(), NombresPredefinidos.TIPO_COGNITIVO);
			} else {
			...
			this.generarInformeConCausaTerminacion(identDeEstaTarea,
					contextoEjecucionTarea, identAgenteOrdenante,
					"Error-Acceso:Interfaz:" + identRecursoVisualizacionAcceso,
					CausaTerminacionTarea.ERROR);
			e.printStackTrace();
		}
	}
