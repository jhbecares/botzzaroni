...
public class PermitirAcceso extends Tarea {
	...
	public void ejecutar(Object... params) {
		...
		try {
			...
			this.generarInformeConCausaTerminacion(identDeEstaTarea,
					contextoEjecucionTarea, identAgenteOrdenante,
					"Error-AlUtilizar:Interfaces_Recurso:"
							+ identRecursoVisualizacionAcceso,
					CausaTerminacionTarea.ERROR);
			e.printStackTrace();
		}
	}
	// El método generarInformOK crea un informe de tarea y se lo envía al
	...
	// El contexto en el que se ejecuta la tarea : ( Opcional) Identificador del
	// objetivo en el que se ejecuta la tarea
	// Identificador del agente que ejecuta la la tarea
	// Texto del informe del resultado de la ejecución:
