...
public class PersistenciaAccesoImp implements Serializable {
	...
	public PersistenciaAccesoImp() {
		...
		try {
			...
			manager = MegaMapManager.getMegaMapManager();
			{
				...
				tablaUsuriosAutorizados = manager.createMegaMap(
						"BdUsuriosAutorizados", true, true);
				// tablaUsuriosAutorizados =
				// manager.getMegaMap("BdUsuriosAutorizados");
	...
	public static void crearUsuariosAutorizados() throws IOException {
	...
	public static boolean compruebaUsuario(String usuario, String password)
		...
		try {
			...
			if (tablaUsuriosAutorizados.hasKey(usuario)) {
				String valorTabla = (String) tablaUsuriosAutorizados
						.get(usuario);
			...
			e.printStackTrace();
			System.out.println("Problema al comprobar usn y pasw  "
					+ e.getCause());
	...
	public void showBDusuarios() throws IOException {
