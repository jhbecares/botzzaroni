...
public class ClaseGeneradoraPersistenciaAccesoSimple extends ImplRecursoSimple
		implements ItfUsoPersistenciaAccesoSimple {
	...
	public ClaseGeneradoraPersistenciaAccesoSimple(String id) throws Exception {
		...
		try {
			...
			trazas.aceptaNuevaTraza(new InfoTraza(this.getId(),
					"Creando la BD " + id, InfoTraza.NivelTraza.debug));
	...
	public boolean compruebaUsuario(String usuario, String password)
		...
		try {
			...
			// password);
			Boolean resconsulta = PersistenciaAccesoImp.compruebaUsuario(
					usuario, password);
