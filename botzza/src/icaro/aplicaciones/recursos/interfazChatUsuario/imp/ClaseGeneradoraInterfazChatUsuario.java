...
public class ClaseGeneradoraInterfazChatUsuario extends ImplRecursoSimple
		implements ItfUsoInterfazChatUsuario {
	...
	public ClaseGeneradoraInterfazChatUsuario(String id) throws Exception {
		...
		notifAgente = new NotificacionesEventosVisAccesoAlta(
				nombredeEsteRecurso, nombreAgenteAreportar);
	...
	private void inicializa() throws Exception {
		...
		trazas.aceptaNuevaTraza(new InfoTraza(nombredeEsteRecurso,
				"Inicializando recurso", InfoTraza.NivelTraza.debug));
	 ...
	 */
	// public void setItfUsoAgenteAcceso(ItfUsoAgenteReactivo
	// itfUsoAgenteAcceso) {
	...
	public void mostrarVisualizadorAcceso(String nombreAgente, String tipo) {
		...
		trazas.aceptaNuevaTraza(new InfoTraza(nombredeEsteRecurso,
				"Mostrando visualizador...", InfoTraza.NivelTraza.debug));
	}

	public void cerrarVisualizadorAcceso() {
		this.ventanaAccesoUsuario.ocultar();
		trazas.aceptaNuevaTraza(new InfoTraza(nombredeEsteRecurso,
				"Cerrando visualizador...", InfoTraza.NivelTraza.debug));
	}

	public void mostrarVisualizadorAccesoAlta(String nombreUsuario) {
		trazas.aceptaNuevaTraza(new InfoTraza(nombredeEsteRecurso,
				"Mostrando recurso...", InfoTraza.NivelTraza.debug));
	...
	public void cerrarVisualizadorAccesoAlta() {
		trazas.aceptaNuevaTraza(new InfoTraza(nombredeEsteRecurso,
				"Cerrando recurso...", InfoTraza.NivelTraza.debug));
	...
	public void mostrarMensajeInformacion(String titulo, String mensaje) {
		...
		JOptionPane.showMessageDialog(ventanaAccesoUsuario, mensaje, titulo,
				JOptionPane.INFORMATION_MESSAGE);

		/*
		 * try { ItfUsoAgenteReactivo itfUsoAgente = (ItfUsoAgenteReactivo)
		 * itfUsoRepositorioInterfaces .obtenerInterfaz("AgenteAccesoUso");
		 * itfUsoAgente.aceptaEvento(new
		 * EventoInput("termina","AgenteAccesoUso","AgenteAccesoUso"));
		 * 
		 * } catch (Exception e) { System.out.println(
		 * "Ha habido un error al enviar el evento termina al agente");
		 * e.printStackTrace(); }
		 */
	}
	...
	public void mostrarMensajeAviso(String titulo, String mensaje) {
		trazas.aceptaNuevaTraza(new InfoTraza(nombredeEsteRecurso,
				"Mostrando mensaje de aviso", InfoTraza.NivelTraza.debug));
		JOptionPane.showMessageDialog(ventanaAccesoUsuario, mensaje, titulo,
	...
	public void mostrarMensajeError(String titulo, String mensaje) {
		trazas.aceptaNuevaTraza(new InfoTraza(nombredeEsteRecurso,
				"Mostrando mensaje de error", InfoTraza.NivelTraza.debug));
		JOptionPane.showMessageDialog(ventanaAccesoUsuario, mensaje, titulo,
	...
	public InterfazUsoAgente getItfUsoAgenteAReportar(String identAgteAreportar) {
		...
		try {
			itfUsoAgteAreportar = (InterfazUsoAgente) NombresPredefinidos.REPOSITORIO_INTERFACES_OBJ
			...
			NombresPredefinidos.RECURSO_TRAZAS_OBJ
					.aceptaNuevaTraza(new InfoTraza(this.nombredeEsteRecurso,
							"Ha habido un problema al obtener la interfaz de uso del agente: "
									+ identAgteAreportar,
