...
public class PanelAccesoAltaUsuario extends VentanaEstandar {
		...
		this.addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent e) {
				JOptionPane
						.showMessageDialog(
								null,
								"Como el control esta en el agente, la ventana no podr� cerrar el sistema directamente...");
			}
		});
		...
		botonAlta.addActionListener(new java.awt.event.ActionListener() {
			...
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				try {
					...
					Logger.getLogger(PanelAccesoAltaUsuario.class.getName())
	...
	private void botonAltaActionPerformed(java.awt.event.ActionEvent evt)
		...
		if ((pwd.equals("")) || (confirm.equals(""))) {
			// usoAgente.getVisualizador().mostrarMensajeError("Error",
			// "Los valores no pueden ser vacios");
			JOptionPane.showMessageDialog(this,
					"Los valores no pueden ser vacios", "Error",
					JOptionPane.ERROR_MESSAGE);
		} else if (new String(textoPwd.getPassword()).equals(new String(
				textoConfirm.getPassword()))) {
			...
			// );
			JOptionPane.showMessageDialog(this,
					"los valores de la clave no coinciden. Deben ser iguales",
