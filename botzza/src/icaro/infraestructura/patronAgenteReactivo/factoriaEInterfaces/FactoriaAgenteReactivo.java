...
public abstract class FactoriaAgenteReactivo extends FactoriaComponenteIcaro {
	...
	public static FactoriaAgenteReactivo instancia() {
		...
		if (instancia == null) {
			String clase = System
					.getProperty(
							"icaro.infraestructura.patronAgenteReactivo.factoriaEInterfaces.imp",
							"icaro.infraestructura.patronAgenteReactivo.factoriaEInterfaces.imp.FactoriaAgenteReactivoInputObjImp0");
			try {
				instancia = (FactoriaAgenteReactivo) Class.forName(clase)
						.newInstance();
			} catch (Exception ex) {
				log.error(
						"Implementacion de la factoria: FactoriaAgenteReactivoImp no encontrada",
						ex);
			}
	...
	public abstract void crearAgenteReactivo(
			DescInstanciaAgente descInstanciaAgente)
			throws ExcepcionEnComponente;

	public abstract void crearAgenteReactivo(String nombreInstanciaAgente,
