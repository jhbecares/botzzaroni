...
public enum TipoAgente {
	...
	COGNITIVO("Cognitivo"), ADO("ADO"), @XmlEnumValue("DirigidoPorObjetivos")
	DIRIGIDO_POR_OBJETIVOS("DirigidoPorObjetivos"), @XmlEnumValue("CognitivoConExpectativas")
	COGNITIVO_CON_EXPECTATIVAS("CognitivoConExpectativas"), @XmlEnumValue("Reactivo")
	REACTIVO("Reactivo"), @XmlEnumValue("ReactivoSCXML")
