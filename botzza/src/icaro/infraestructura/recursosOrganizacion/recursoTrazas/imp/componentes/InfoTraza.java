...
public class InfoTraza {
	...
	// {Cognitivo,ADO,DirigidoPorObjetivos,Reactivo,Recurso}
	...
	public InfoTraza(String idEntidadEmisora,
			NombresPredefinidos.TipoEntidad tipoEnt, String contenido,
			NivelTraza nivel) {
	...
	public void setNivel(NivelTraza n) {
		this.nivel = n;
	}

	public String getEntidadEmisora() {
		return this.identEntidadEmisora;
	}
	...
	public NombresPredefinidos.TipoEntidad getTipoEntidadEmisora() {
		return this.tipoEntidadEmisora;
	}
