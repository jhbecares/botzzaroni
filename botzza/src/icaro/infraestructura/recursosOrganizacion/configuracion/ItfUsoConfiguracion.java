...
public interface ItfUsoConfiguracion extends ItfUsoRecursoSimple {
	...
	public DescInstanciaAgenteAplicacion getDescInstanciaAgenteAplicacion(
			String id) throws ExcepcionEnComponente, RemoteException;
	...
	public Properties getPropiedadesGlobales() throws ExcepcionEnComponente,
			RemoteException;

	public Boolean existeDescInstancia(String id) throws ExcepcionEnComponente,
			RemoteException;

	public String getIdentGestorInicial() throws ExcepcionEnComponente,
			RemoteException;
